            ...
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="w-full sm:w-4/5 p-2 mt-4 mx-auto">
                  <a
                    className="py-4 px-6 w-full text-white font-semibold text-center rounded-xl shadow-4xl focus:ring focus:ring-indigo-300 bg-customPrimary hover:bg-[#7765e6] transition ease-in-out duration-200"
                    type="button"
                    href={LINKS.BUTTON.href}
                  >
                    
                    {LINKS.BUTTON.content}
                  </a>
                </div>
              </div>
            </div>
